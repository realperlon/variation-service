...
public class ObjectJSONMessageBodyWriter implements MessageBodyWriter<Object> {
	...
	static Logger logger = LoggerFactory.getLogger(ObjectJSONMessageBodyWriter.class);
	
	public ObjectJSONMessageBodyWriter(){
		super();
